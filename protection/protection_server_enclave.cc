...
#include "protection/protection_server.h"
...
namespace kx {
    namespace protection {
        class KxProtectionServerEnclave final : public asylo::TrustedApplication {
        public:
        ...
        private:
            ...
            std::unique_ptr<ProtectionServer> service_;
        ...
        ABSL_LOCKS_EXCLUDED(server_mutex_) {
                ...
                service_ = absl::make_unique<ProtectionServer>();
